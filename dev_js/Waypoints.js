var WayPoint = function ( _lon, _lat,_zoom, _name, _textureName ) {
...
WayPoint.prototype.updatePos = function() {
	if( this.showSprite ){
		// var pos = OEV.earth.coordToXYZ( this.lon, this.lat, OEV.earth.meter * 100 );
...
WayPoint.prototype.resize = function( _scale ) {
	if( this.showSprite ){
...
WayPoint.prototype.hide = function( _state ) {
	if( this.showSprite ){
...
WayPoint.prototype.dispose = function() {
	if( this.showSprite ){
		OEV.scene.remove( this.sprite );
	}
}
