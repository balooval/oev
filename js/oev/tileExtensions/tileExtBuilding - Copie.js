...
Oev.Tile.Extension.Building = function(_tile) {
	...
	ext.makeWalls = function( _pts, _params ) {
		...
		// TODO : récupérer la tile courante pour y faire un getElevation direct dessus
		// en fait les points peuvent déborder de la tuile courante ...
	...
	ext.construct = function() {
		...
		if (this.geometry === undefined) {
			console.log('Error', this.datas.length);
		}
