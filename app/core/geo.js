...
export function coordToCanvas(box, canvasSize, coords) {
...
export function tileToCoordsVect(tileX, tileY, zoom){
	const res = tileToCoords(tileX, tileY, zoom);
...
export function metersBetweenCoords(lon1, lat1, lon2, lat2) {
	const rayon = 6371000;
...
export function getAltitude(zoomlevel, radius, projection) {
